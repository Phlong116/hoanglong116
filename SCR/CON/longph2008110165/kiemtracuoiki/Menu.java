package com.longph2008110165.codecuoiki;
...
public class Main {
	...
	private static void DuLieuCoSan() {
		//thực phẩm
			...
			H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_04", "thuc an dong vat", 2500, 50, LocalDate.parse("02/01/2010", formatter)));
			H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_05", "banh mi", 2500, 50, LocalDate.parse("05/01/2010", formatter)));
			H_Hoa.add(new HangHoa(Loai.Thuc_Pham, "TP_06", "gao", 2500, 50, LocalDate.parse("06/01/2010", formatter)));
		...
		//sành sứ
			...
			H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_04", "to su", 1200, 3, LocalDate.parse("07/04/2014", formatter)));
			H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_05", "dua muong", 1200, 3, LocalDate.parse("04/04/2014", formatter)));
			H_Hoa.add(new HangHoa(Loai.Sanh_Su, "SS_06", "tuong", 1200, 3, LocalDate.parse("04/04/2014", formatter)));
		//đồ điện
			...
			H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_04", "laptop ", 8000000, 150, LocalDate.parse("10/07/2017", formatter)));
			H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_05", "ban phim", 8000000, 150, LocalDate.parse("15/07/2017", formatter)));
			H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_06", "man hinh", 8000000, 150, LocalDate.parse("20/07/2017", formatter)));
			H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_07", "tu lanh", 8000000, 150, LocalDate.parse("13/07/2017", formatter)));
			H_Hoa.add(new HangHoa(Loai.Dien_May, "DM_08", "o dien", 8000000, 150, LocalDate.parse("21/07/2017", formatter)));
